...
<section class="body1">
    ...
    <table>
        ...
        <tbody>
            <c:forEach items="${contact}" var="contactus">
                <tr>
                    <td>${contactus.u_id}</td>
                    <td>${contactus.user_firstname}</td>
                    <td>${contactus.user_lastname}</td>
                    <td>${contactus.user_phonenumber}</td>
                    <td>${contactus.u_email}</td>
                    <td>${contactus.u_message}</td>
                </tr>
            </c:forEach>
        </tbody>
    </table>

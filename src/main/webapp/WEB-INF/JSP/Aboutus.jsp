...
@media (max-width: 875px)
{
    ...
    @media(max-width: 848px)
    {
        ...
        .container {
            ...
            border-radius: 10px;
            box-shadow: 0px 3px 15px rgba(113, 115, 119, 1.5);*/
            text-align: center;
            padding: 20px 0px;
        }
...
<section>
    <div class="container">
		<div class="content">
			<h1>Overview</h1>
			<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, urna vel bibendum bibendum, nunc sapien faucibus sapien, vel bibendum sapien sapien vel sapien. Sed euismod, urna vel bibendum bibendum, nunc sapien faucibus sapien, vel bibendum sapien sapien vel sapien.</p>
		</div>
		<div class="image">
			<img src="https://th.bing.com/th/id/R.cc7beb3d9857a9a9181e483458c6afca?rik=OWB9Iukqvmngqw&riu=http%3a%2f%2fjoeycleary.com%2fblog%2fwp-content%2fuploads%2f2012%2f03%2fIMG_2211b.jpg&ehk=FHzttuv5krNoc84mAwX25GyDiHbfajdkt4AJpV0TKl8%3d&risl=&pid=ImgRaw&r=0" alt="Image" width="600px" height="500px">
		</div>
	</div>
</section>

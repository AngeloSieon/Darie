...
<body>
        ...
        <div class="container">
            <form action="/contact" method="post">
              ...
              <div class="form-field">
                ...
                <input type="tel" id="phone" name="user_phonenumber" required>
              </div>
              ...
              <div class="form-field">
                ...
                <textarea id="message" name="u_message" required></textarea>
              </div>
          
              <div class="form-field">
                <label for="product">Select Product:</label>
                <select id="product" name="u_products">
                  <option value="product1">Nylon Multi-Filament Nets</option>
                  <option value="product2">Polyester Fishing Net</option>
                  <option value="product3">Nylon Mono-Filament Nets</option>
                </select>
              </div>
    ...
    <section class="footer">
            ...
            <div class="footer-block-list">
                <div class="footer-block-text">
                    <div class="v-stack1">
                        ...
                        <div class="prose">
                            <p>Darie Marine is a Modern Sustainable Brand for Fish Nets.</p>
                        </div>
                        <ul class="social-media" role="list">
                            <li class="social-media-item-facebook">
                                <a href="#" class="tap-area" target="_blank" rel="noopener" aria-label="Follow on Facebook">
                                    <svg aria-hidden="true" focusable="false" width="24" class="icon icon-facebook"
                                        viewBox="0 0 24 24">
                            ...
                            <li class="social-media-item-twitter">
                                <a href="#" class="tap-area" target="_blank" rel="noopener" aria-label="Follow on Twitter">
                                    <svg aria-hidden="true" focusable="false" width="24" class="icon icon-twitter"
                                        viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="social-media-item-instagram">
                                <a href="#" class="tap-area" target="_blank" rel="noopener"
                                    aria-label="Follow on Instagram">
                                    <svg aria-hidden="true" focusable="false" width="24" class="icon icon-instagram"
                                        viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="social-media-item-pinterest">
                                <a href="#" class="tap-area" target="_blank" rel="noopener"
                                    ...
                                    <svg aria-hidden="true" focusable="false" width="24" class="icon icon-pinterest"
                                        viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="social-media-item-youtube">
                                <a href="#" class="tap-area" target="_blank" rel="noopener" aria-label="Follow on YouTube">
                                    <svg aria-hidden="true" focusable="false" width="24" class="icon icon-youtube"
                                        viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="social-media-item-linkedin">
                                <a href="#" class="tap-area" target="_blank" rel="noopener" aria-label="Follow on LinkedIn">
                                    <svg aria-hidden="true" focusable="false" width="24" class="icon icon-linkedin"
                                        viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="additional-content">
            <p>Darie Marine is a Fishing Nets product seller Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum,
                at praesentium maiores, temporibus quae, accusamus eligendi nulla vero sed deleniti ipsa eos facilis!
                Asperiores, libero recusandae harum magnam maxime, dolorum, dolore sit temporibus eos nam fuga dicta totam.
                Saepe eos voluptate suscipit cum, autem iure qui unde modi, rerum nulla aliquid dolore maxime ducimus rem
                praesentium, et nam soluta ratione totam harum nemo. Reprehenderit, rem voluptatem modi magnam ratione, sint
                nulla, aliquam asperiores dolorum veritatis cumque aperiam doloribus voluptatibus molestias. Illo nesciunt
                quia atque ea eius quaerat, nihil perspiciatis aperiam ipsum aliquid at veniam aliquam perferendis sit
                repudiandae asperiores. Vero! All products are PeTA Approved.</p>
        </div>

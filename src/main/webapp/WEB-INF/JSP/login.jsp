...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <!---------------Css linking---------------->
    <!--<link rel="stylesheet" type="text/css" href="darie_marine_login.css">-->
    <!----------------title image--------------->
        ...
        <div class="regform">
            ...
            <form action="/submitnew" method="POST">
                ...
                <div class="input">
                    ...
                    <input type="text" name="Uname" placeholder="abcd@gamil.com">
                </div>
        ...
        <div class="footer-block-list">       
            ...
            <div class="footer-block-useful-links">
                <div class="v-stack3">
                    ...
                    <ul class="v-stack-list" role="list">
                        ...
                        <li><a href="#" class="link-reverse">FAQs</a></li>
                        <li><a href="#" class="link-reverse">Discounts</a></li>
            ...
            <div class="footer-block-newsletter">
                <div class="v-stack4">
                    ...
                    <form method="post" action="/contact#newsletter-form-sections--20351879446824__footer" id="newsletter-form-sections--20351879446824__footer" accept-charset="UTF-8" class="form">
                        <input type="hidden" name="form_type" value="customer">
                        <input type="hidden" name="utf8" value="✓">
                        <input type="hidden" name="contact[tags]" value="newsletter">
                        <div>
                            <input id="input-sections--20351879446824__footer--contactemail" class="input" type="email" dir="ltr" name="contact[email]" placeholder="Enter your email address" autocomplete="email" enterkeyhint="send" required="">
                        </div>

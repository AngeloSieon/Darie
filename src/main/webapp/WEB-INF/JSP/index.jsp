...
<meta charset="UTF-8">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <!---------------Css linking---------------->
    <!--<link rel="stylesheet" type="text/css" href="darie_marine_home.css">-->
    <!----------------title image--------------->
...
.body1
{
    min-height: 85vh;
    width: 100%;
    background-image: linear-gradient(rgba(4,9,30,0.5),rgba(4,9,30,0.5)),url(https://media.istockphoto.com/id/855462846/photo/abstraction-in-plastic-net.jpg?s=612x612&w=0&k=20&c=w8d1jbfe7zjLhYMve24kKOlAE2Hz1DtJrIVudGT9jMA=)/*(https://th.bing.com/th/id/OIP.1T051yLkK9vcJm_tUu4qEwHaEK?w=1920&h=1080&rs=1&pid=ImgDetMain)*/;
...
<!------------------- 1 body section and text ---------------------->
<section class="body1">
    <div class="text">
        <h3>We are the leading manufacturer and supplier of premium quality fishing nets in India.</h3>
        <h1>Offer An Impressive Range of Supreme Quality Fishing Nets</h1>
        <h6>We manufacture all kinds of Nylon Multifilament and Nylon Monofilament fishing nets.</h6>
    </div>   
</section>
...
<!----------------- body 2 ------------------->
    <section>
        <div class="first">
            <div class="second">
                <div class="left">
                    <h1 class="paragraph1">Quality Product</h1>
                    <p class="paragraph2">Fabricated with high quality twine to enhance the durability</p>
                    <button class="button1" ><a href="/OurProducts">Products</a> </button>
                </div>
                <div class="right">
                    <h1 class="paragraph3">Contact For Whole Sale</h1>
                    <button class="button2"><a href="/Contactus">Contact Us</a></button>
                </div>
            </div>
        </div>
    </section>
...
<!--------------------body 3----------------->
    <section>
        <div class="container">
            <div class="left1">
                <img class="image1"
                    src="https://thumbs.dreamstime.com/b/view-fishing-net-front-boat-beach-beautiful-calm-sea-water-hot-summer-day-view-139559201.jpg"
                    alt="Image">
            </div>
            <div class="center-right">
                <img class="image2" src="https://th.bing.com/th/id/OIP.FzllOnkepCAZ5bGAUM3ceAAAAA?rs=1&pid=ImgDetMain"
                    alt="Image">
            </div>
            <div class="right1">
                <h3>About Darie Marine</h3>
                <h1>DARIE FISHNETS INDIA S LEADING PROVIDER OF FISHING NETS</h1>
                <p>Darie Fishnets started in the year 1995 by an aspiring businessman Mr.Darie Kurkes, who was a
                    fisherman himself hoping to manufacture fishing nets that can satisfy him and his fellow fishermen
                    needs. With time Darie Fishnets turned out to be an unavoidable and popular fishing nets in the industry.
                </p>
                <p>Our fishnets are fabricated with high-quality twine in order to enhance the durability and softness for a
                    good catch. We are using skilled manpower with advanced technology to meet the touch of fishermen.
                    Moreover, Mano Fishing Nets stand for quality, durability, and performance. We can customize the knot
                    (single/ double), sizes, depth, colour, and other varied specifications according to the diverse demands
                    of buyers. We provide premium quality fishing nets at a reasonable price. Our supply chain of fishing
                    nets spreads across different parts of India and overseas.</p>
                <div class="email">
                    <img class="icon-body3"
                        src="https://th.bing.com/th/id/R.3cc4d71ef0d49b1de9771d3d2159a57d?rik=4DhEKOaV9Xy05w&riu=http%3a%2f%2fpluspng.com%2fimg-png%2femail-icon-png-email-icon-image-122-2400.png&ehk=ysN53EM4TZXnpAYPdVx4gyPi9yAxhixiW8uwFiA1CvM%3d&risl=&pid=ImgRaw&r=0"
                        alt="Email Icon">
                    <p>angsieon01@gmail.com</p>
                </div>
                <div class="phone">
                    <img class="icon-body3"
                        src="https://www.pinclipart.com/picdir/middle/111-1111519_paragon-logo-mass-effect-clipart.png"
                        alt="Phone Icon">
                    <p>+91 9840447733</p>
                </div>
                <div class="phone">
                <img class="icon-body3"
                    src="https://p1.hiclipart.com/preview/320/732/953/metrostation-map-marker-icon-png-clipart.jpg"
                    alt="Phone Icon">
                <p>No: 7/3 Jawahar Street West K K Nagar Chennai-78</p>
            </div>
            </div>
        </div>
    </section>
